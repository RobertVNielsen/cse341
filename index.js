...
const MONGODB_URL = process.env.MONGODB_URL || "mongodb+srv://nielrobe:GhostMantis9@cse341cluster-3dwlw.mongodb.net/test?retryWrites=true&w=majority";
...
app.use(express.static(path.join(__dirname, 'public')))
   ...
   ////////.use('/add-product', addProductRoutes)
   .get('/', (req, res, next) => {
...
///////////////////
/* mongoosekkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk
  .connect(
    MONGODB_URL, options
  )
  .then(result => {
